...
public class DBService {
	...
	public void instrantiateTestDataBase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "kohatsukendi@gmail.com", "36378912377",
				TipoCliente.PESSOAFISICA, encoder.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

		Cliente cli2 = new Cliente(null, "AnaCosta", "kendi42@hotmail.com", "92441339036", TipoCliente.PESSOAFISICA,
				encoder.encode("123"));
		...
		Pagamento pagto2 = new PagamentoComBoleto(null, EstadoPagamento.PENDENTE, ped2,
				formato.parse("20/10/2017 00:00"), null);
