...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.kohatsu.cursomc.resources"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo(
				...
				"Esta API foi utilizada no curso Spring Boot do prof. Nelio Alves, e desenvolvido por Alisson Kohatsu", 
				"Versão 1.0", 
				"https://www.udemy.com/terms", 
				new Contact("Alisson Kendi Kohatsu", "https://www.facebook.com/kendi.kohatsu", "kohatsukendi@gmail.com"), 
