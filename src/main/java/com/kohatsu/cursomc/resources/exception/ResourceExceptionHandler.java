...
import com.kohatsu.cursomc.servicies.exceptions.DataIntegrityViolationException;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> methodArgumentException(MethodArgumentNotValidException e, HttpServletRequest request){
